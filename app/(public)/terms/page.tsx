    ...
    <section className="max-w-3xl mx-auto px-5 py-16">
      ...
      <div className="space-y-6 text-[#4A3B63] leading-relaxed text-sm sm:text-base">
        <div className="bg-white/80 backdrop-blur-md border border-white/90 shadow-sm rounded-2xl p-6 space-y-2">
          <h2 className="text-[#2D1B4E] font-bold text-base sm:text-lg">1. Acceptance</h2>
          <p>By using AURA SMM or creating an account, you agree to these terms. If you do not agree, please stop using the service.</p>
        </div>

        <div className="bg-white/80 backdrop-blur-md border border-white/90 shadow-sm rounded-2xl p-6 space-y-2">
          <h2 className="text-[#2D1B4E] font-bold text-base sm:text-lg">2. Services</h2>
        ...
        <div className="bg-white/80 backdrop-blur-md border border-white/90 shadow-sm rounded-2xl p-6 space-y-2">
          <h2 className="text-[#2D1B4E] font-bold text-base sm:text-lg">3. Credits and refunds</h2>
        ...
        <div className="bg-white/80 backdrop-blur-md border border-white/90 shadow-sm rounded-2xl p-6 space-y-2">
          <h2 className="text-[#2D1B4E] font-bold text-base sm:text-lg">4. User responsibilities</h2>
          <ul className="list-disc list-inside space-y-2">
        ...
        <div className="bg-white/80 backdrop-blur-md border border-white/90 shadow-sm rounded-2xl p-6 space-y-2">
          <h2 className="text-[#2D1B4E] font-bold text-base sm:text-lg">5. Disclaimer</h2>
