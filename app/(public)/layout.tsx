        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 space-y-10">
          ...
          <div className="p-4 rounded-2xl bg-white/40 border border-white/70 backdrop-blur-md flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs text-[#4A3B63]">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <span className="font-bold text-[#2D1B4E]">นโยบายการคืนเงินและเครดิต:</span>{' '}
                <span>ระบบไม่สามารถขอคืนเงินสดกลับเข้าบัญชีธนาคารได้ แต่หากคำสั่งซื้อเกิดปัญหาหรือไม่สามารถส่งมอบได้ ระบบจะคืนเป็น &ldquo;เครดิตในระบบ&rdquo; เข้ากระเป๋าเงินของคุณทันทีอัตโนมัติ 100%</span>
              </div>
            </div>
            <Link
              href="/refund"
